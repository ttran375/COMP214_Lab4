...
DECLARE
    ...
    -- Procedure to calculate the next due date based on the previous due date
    FUNCTION calculate_next_due_date(p_start_date DATE, p_payment_number NUMBER) RETURN DATE IS
    BEGIN
        RETURN ADD_MONTHS(p_start_date, p_payment_number - 1);
    END calculate_next_due_date;
...
BEGIN
    ...
    FOR payment_number IN 1..v_total_payments LOOP
        ...
        v_start_date := calculate_next_due_date(v_start_date, payment_number);
