...
DECLARE
    lv_item_price NUMBER := 50; -- Initialize with the price of one item
    lv_total_available NUMBER := 300; -- Initialize with the total amount available to spend
    lv_items_purchased NUMBER := 0; -- Initialize the count of items purchased
BEGIN
